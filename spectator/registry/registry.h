...
class Registry
{
   public:
	...
	auto AgeGauges() const -> std::vector<std::shared_ptr<const AgeGauge>> { return all_meters_.age_gauges_.get_values(); }
	...
	auto MaxGauges() const -> std::vector<std::shared_ptr<const MaxGauge>> { return all_meters_.max_gauges_.get_values(); }
